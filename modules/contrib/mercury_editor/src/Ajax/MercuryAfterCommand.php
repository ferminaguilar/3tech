...
/**
 * Inserts markup after the last element matching a selector.
 */
class MercuryAfterCommand extends InsertCommand {

  /**
   * Constructs a MercuryAfterCommand object.
   *
