...
class __TwigTemplate_6e95f645af4a54309435251b3200857e extends Template
{
...
($context["is_top_level_menu"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp) && (($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["item"], "below", [], "any", false, false, true, 129)) && $tmp instanceof Markup ? (string) $tmp : $tmp))) ? ("primary-nav-submenu-toggle-button") : (false))]), "html", null, true);
  ...
  ";
    ...
    {
        return new Source("", "core/themes/olivero/templates/navigation/menu--primary-menu.html.twig", "/Applications/MAMP/htdocs/3tech/core/themes/olivero/templates/navigation/menu--primary-menu.html.twig");
    }
